...
# ---------------- CONFIG (fill these) ----------------
GUILD_ID = 1502484386057027676  # your guild/server ID

# channels
# channels
TRANSACTIONS_ID = 1508547494005440573
MATCH_TIMES_CHANNEL_ID = 1502818882056884234
ASSIGNMENTS_CHANNEL_ID = 1508547606538752100
SCRIM_CATEGORY_ID = 0  # put your Scheduling category ID here, or 0 to create/use none
MATCH_SCORES_CHANNEL_ID = 1502818940424814663  # put your match-score channel ID here

# staff/team roles
CAPTAIN_ROLE_ID = 1508547735194697941
CO_CAPTAIN_ROLE_ID = 1508547765062598888
EXECUTIVE_ROLE_ID = 1508547798151335997
TEAM_PLAYER_ROLE_ID = 1508547781944414228

# assignment roles
HEAD_REF_ROLE_ID = 1508547987758907564
REF_ROLE_ID = 1508547973490151526
HEAD_CASTER_ROLE_ID = 1508547958247788544
CASTER_ROLE_ID = 1508547941357322480

FAQ_CHANNEL_ID = 1508547674780209203  # replace with the channel ID where FAQ should be posted
...
async def admin_info(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        title="CTA Transactions Bot – Admin Command Guide",
...
@bot.tree.command(
    guild=GUILD_OBJ,
    name="faq",
    description="Post the CTA FAQ and auto-role buttons (admins only)."
)
async def faq(interaction: discord.Interaction):
    ...
    text = (
        ...
        "> - We will use <#1502799482348109994> to update you on our team situation! We pick the best teams we can from out forms, so make sure you are active and competitive!\n"
        ...
        "## • Application Forms\n\n"
        "> - CTA has a various list of positions and applications to better help the league!,\n"
...
async def code(interaction: discord.Interaction, team1: discord.Role, team2: discord.Role):
    ...
    await interaction.response.defer(ephemeral=True)
    code_value = f"CTA{random.randint(1000, 9999)}"
